...
const PropertySection = () => {
    return (
        <div className='mt-24 w-[90%] mx-auto flex justify-between'>
            {/* image section */}
            <div className='flex-1'>
                <div className='relative'>
                    <img className='h-[22rem] w-[28rem] rounded-lg' src={img1} alt="" />
                    <div className='absolute left-28 bottom-[-90px]'>
                        <img className='h-60 w-[30rem] object-cover rounded-lg shadow-2xl' src={img2} alt="" />
                        <div className='absolute right-28 top-[-40px]'>
                            <PlayBtn />
                        </div>
                    </div>
                </div>
